...
(function (TH) {
  ...
  const NAV_ITEMS = {
    ...
    'crm-overview': navItem('crm-overview', 'Tổng quan kinh doanh', 'bar-chart-2', '#/crm', 'crm.view', 2), crm: navItem('crm', 'Khách hàng / Lead', 'user', '#/crm/leads', 'crm.view', 2),
    ...
    maintenance: navItem('maintenance', 'Bảo trì & sự cố', 'wrench', '#/maintenance', 'maintenance.view', 2), tasks: navItem('tasks', 'Lịch công việc', 'calendar', '#/maintenance/schedules', 'maintenance.view', 2),
    ...
    'zalo-history': navItem('zalo-history', 'Lịch sử gửi Zalo', 'send', '#/zalo/history', 'zalo.view'), reports: navItem('reports', 'Báo cáo tổng quan', 'bar-chart', '#/reports', 'reports.view'),
  ...
  const ROLE_NAV_LAYOUT = {
    admin: [home('Tổng quan'), section('leasing', 'Quản lý cho thuê', 'building', ['rooms', 'buildings', 'tenants', 'contracts', 'ocr', 'landlords']), section('business', 'Kinh doanh', 'briefcase', ['crm-overview', 'crm', 'viewings', 'holds', 'deals']), section('finance', 'Tài chính', 'wallet', ['invoices', 'receivables', 'refunds', 'deposits', 'expenses', 'bank']), section('operations', 'Vận hành', 'wrench', ['maintenance', 'tasks', 'documents', 'assets', 'inventory', 'zalo-history']), section('reports', 'Báo cáo', 'bar-chart', ['reports', 'reports-detail', 'cashbook'])],
    ops: [home('Công việc của tôi'), section('property', 'Phòng & tòa nhà', 'building', ['rooms', 'buildings', 'landlords']), section('leasing', 'Khách thuê & hợp đồng', 'file-text', ['tenants', 'contracts', 'ocr']), section('collection', 'Tài chính vận hành', 'wallet', ['invoices', 'receivables', 'refunds', 'deposits', 'expenses']), section('maintenance', 'Bảo trì & tài sản', 'wrench', ['maintenance', 'tasks', 'documents', 'assets', 'inventory']), section('sales-ops', 'Hỗ trợ kinh doanh', 'calendar-check', ['crm', 'viewings', 'holds'])],
    accountant: [home('Công việc của tôi'), section('finance', 'Tài chính', 'wallet', ['invoices', 'receivables', 'deposits', 'refunds', 'expenses', 'bank']), section('data', 'Dữ liệu & đối soát', 'database', ['statement', 'opening', 'jobs', 'documents', 'inventory']), section('reports', 'Báo cáo', 'bar-chart', ['reports', 'reports-detail', 'cashbook']), section('reference', 'Tra cứu', 'search', ['rooms', 'buildings', 'tenants', 'contracts', 'landlords', 'maintenance'])],
    sale: [home('Công việc của tôi'), section('business', 'Kinh doanh', 'briefcase', ['crm-overview', 'crm', 'viewings', 'holds', 'deals']), section('reference', 'Tra cứu', 'search', ['rooms', 'buildings', 'tenants', 'contracts'])],
    kythuat: [home('Công việc của tôi'), section('maintenance', 'Công việc kỹ thuật', 'wrench', [{ key: 'maintenance', label: 'Sự cố được giao', href: '#/maintenance?assignee=me' }, { key: 'tasks', label: 'Lịch bảo dưỡng' }]), section('reference', 'Tra cứu', 'search', ['rooms', 'buildings', 'assets', 'inventory', { key: 'expenses', label: 'Chi phí sự cố' }])],
