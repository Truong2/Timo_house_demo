...
(function (TH) {
  ...
  const NAV_ITEMS = {
    ...
    commissions: navItem('commissions', 'Hoa hồng', 'banknote', '#/commissions', 'commissions.view'), 'head-lease-costs': navItem('head-lease-costs', 'Tiền thuê nhà & trả trước', 'home', '#/head-lease-costs', 'headLeaseCosts.view'),
    ...
    // Spec v1.8 W5 – báo cáo Phase 1 §4.28/§12.23 + cổ phần/góp vốn/phân phối §4.29–4.32
    'report-a': navItem('report-a', 'Báo cáo chi tiết tòa', 'file-text', '#/reports/building-profit', 'reports.view'), 'report-b': navItem('report-b', 'Báo cáo kinh doanh T/S/G', 'layers', '#/reports/business-summary', 'reports.view'), 'report-periods': navItem('report-periods', 'Kỳ báo cáo & snapshot', 'lock', '#/reports/periods', 'reports.view'), 'report-reconcile': navItem('report-reconcile', 'Đối soát Excel (golden)', 'check-square', '#/reports/reconcile', 'reports.view'), metrics: navItem('metrics', 'Metric Registry', 'book', '#/reports/metrics', 'reports.view'),
    shares: navItem('shares', 'Cổ phần theo tòa', 'sliders', '#/investment/shares', 'shares.view'), capital: navItem('capital', 'Góp vốn theo tòa', 'hand-coins', '#/investment/shareholders?tab=capital', 'shareholders.view'), distribution: navItem('distribution', 'Phân phối lợi nhuận', 'chart-pie', '#/investment/shareholders?tab=profit', 'shareholders.view'),
    ...
    hr: navItem('hr', 'Nhân viên', 'users', '#/hr', 'hr.view'), timesheet: navItem('timesheet', 'Chấm công', 'clock', '#/hr/timesheet', 'timesheet.view', 3), payroll: navItem('payroll', 'Bảng lương', 'banknote', '#/hr/payroll', 'payroll.view'), 'collection-perf': navItem('collection-perf', 'Hiệu suất thu tiền', 'trending-up', '#/hr/collection-performance', 'performance.view'), 'salary-payments': navItem('salary-payments', 'Chi lương', 'hand-coins', '#/hr/salary-payments', 'salary.view'),
  ...
  const ROLE_NAV_LAYOUT = {
    admin: [home('Tổng quan'), section('leasing', 'Vận hành', 'building', ['contracts', 'ocr', 'expiring', 'buildings', 'rooms', 'tenants', 'landlords', 'refunds']), section('finance', 'Tài chính', 'wallet', ['meters', 'invoices', 'billing-periods', 'receivables', 'expenses', 'deposits', 'commissions', 'head-lease-costs', 'bank']), section('business', 'Kinh doanh', 'briefcase', ['crm-overview', 'crm', 'viewings', 'holds', 'deals']), section('hr', 'Nhân sự', 'users', ['org', 'hr', 'assignments', 'collection-perf', 'payroll', 'salary-payments', 'timesheet']), section('assets', 'Tài sản & bảo trì', 'package', ['assets', 'inventory', 'maintenance', 'tasks', 'documents']), section('investment', 'Đầu tư', 'trending-up', ['shareholders', 'shares', 'capital', 'distribution', 'projects', 'roi']), section('notify', 'Thông báo', 'send', ['zalo-history', 'zalo-config']), section('reports', 'Báo cáo', 'bar-chart', ['reports', 'report-a', 'report-b', 'report-periods', 'report-reconcile', 'metrics', 'reports-detail', 'cashbook'])],
    qltong: [home('Tổng quan'), section('leasing', 'Vận hành', 'building', ['contracts', 'expiring', 'buildings', 'rooms', 'tenants', 'landlords', 'refunds']), section('finance', 'Tài chính', 'wallet', ['meters', 'invoices', 'billing-periods', 'receivables', 'expenses', 'deposits', 'head-lease-costs']), section('hr', 'Nhân sự', 'users', ['org', 'hr', 'assignments', 'collection-perf', 'payroll']), section('investment', 'Đầu tư', 'trending-up', ['shareholders', 'shares', 'capital', 'distribution', 'projects', 'roi']), section('reports', 'Báo cáo', 'bar-chart', ['reports', 'report-a', 'report-b', 'report-periods', 'report-reconcile', 'metrics', 'reports-detail', 'cashbook'])],
    ...
    accountant: [home('Công việc của tôi'), section('finance', 'Tài chính', 'wallet', ['meters', 'invoices', 'billing-periods', 'receivables', 'deposits', 'refunds', 'expenses', 'commissions', 'head-lease-costs', 'bank']), section('data', 'Dữ liệu & đối soát', 'database', ['statement', 'opening', 'jobs', 'documents', 'inventory']), section('hr', 'Nhân sự', 'users', ['collection-perf', 'payroll', 'salary-payments']), section('investment', 'Đầu tư', 'trending-up', ['shareholders', 'shares', 'capital', 'distribution']), section('reports', 'Báo cáo', 'bar-chart', ['reports', 'report-a', 'report-b', 'report-periods', 'report-reconcile', 'metrics', 'reports-detail', 'cashbook']), section('reference', 'Tra cứu', 'search', ['rooms', 'buildings', 'tenants', 'contracts', 'landlords', 'assignments', 'deals', 'maintenance'])],
    ...
    hr: [home('Công việc của tôi'), section('hr', 'Nhân sự', 'users', ['org', 'hr', 'assignments', 'collection-perf', 'payroll', 'salary-payments', 'timesheet']), section('reference', 'Tra cứu', 'search', ['buildings', 'rooms'])],
    codong: [home('Tổng quan đầu tư'), section('investment', 'Đầu tư', 'trending-up', ['shareholders', 'shares', 'capital', 'distribution', 'projects', 'roi'])],
  };
  ...
  L.P2_INFO = {
    ...
    'collection-perf': ['Hiệu suất thu tiền', 1, 'NV × tòa: số phòng, DT niêm yết/phải thu, thu M1/M2/M3, dịch vụ, thu thêm, hiệu suất, mức lương/phòng; drill-down về Payment (spec v1.8 §4.26.1).', 'Phase 1'],
    'salary-payments': ['Chi lương', 1, 'Danh sách chi lương từ bảng lương đã khóa: chi từng người/hàng loạt, partial, import kết quả GD, chứng từ, lịch sử (spec v1.8 §4.26.8).', 'Phase 1'],
  ...
  const launcherApps = () => [
    ...
    { label: 'Đầu tư', text: 'Cổ đông, cổ phần theo tòa, góp vốn, phân phối LN từ báo cáo khóa', icon: 'trending-up', href: '#/investment/shareholders', permission: 'shareholders.view' },
