...
- Guide: luồng **F14 "Hiệu suất thu tiền → bảng lương → chi lương"** (4 mốc) và **F15 "Import chi phí & phân bổ chi phí chung"** (2 mốc); F17 P3 chỉ còn NV/phân công/chấm công mô phỏng; walkthrough P1 48/48 (thêm F14.1–F14.3, F15.1).
...
### Kịch bản demo Phase 3 (panel Hướng dẫn, +4 luồng / 14 mốc khi bật P3 – bảng lương đã chuyển sang F14 Phase 1)
