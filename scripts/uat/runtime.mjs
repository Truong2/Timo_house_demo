...
export const FLOW_TRACE = {
  ...
  F20: 'Kiểm kê tài sản (FR-BLD-04, FR-MNT-02)', F21: 'Nhân sự → phân công → bảng công mô phỏng (lương P1: F14 §4.26)', F22: 'Cổ đông, vốn góp, phân phối, scope cổ đông (FR-INV-01..04, D-14)', F23: 'Ngân hàng & đối soát (FR-FIN-07)',
};
